...
public class FileSystemModel implements TreeModel {
    ...
    // TreeFile is a File subclass that overrides method toString to return only the File name.
    private class TreeFile extends File {
        ...
        // override method toString to return only the File name and not the full path
        @Override
