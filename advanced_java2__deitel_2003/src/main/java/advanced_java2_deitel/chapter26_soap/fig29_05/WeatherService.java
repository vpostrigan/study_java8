...
public class WeatherService {
    ...
    private void updateWeatherConditions() {
        try {
            ...
            // If the line length is not at least 28 characters long, then done processing data.
            while (inputLine.length() > 28) {
                ...
                weatherInformation.add(inputLine.substring(0, 16));
                weatherInformation.add(inputLine.substring(16, 22));
                weatherInformation.add(inputLine.substring(23, 29));
