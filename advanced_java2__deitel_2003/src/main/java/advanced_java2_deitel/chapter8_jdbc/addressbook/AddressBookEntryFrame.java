...
public class AddressBookEntryFrame extends JInternalFrame {
    ...
    // static integers used to determine new window positions for cascading windows
    private static int xOffset = 0, yOffset = 0;

    // static Strings that represent name of each text field.
    // These are placed on JLabels and used as keys in HashMap fields.
    ...
    // set AddressBookEntry then use its properties to place data in each JTextField
    ...
    // store AddressBookEntry data from GUI and return AddressBookEntry
    ...
    // set text in JTextField by specifying field's name and value
