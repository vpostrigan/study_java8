 ...
 * Generated by the IDL-to-Java compiler (portable), version "3.0" from systemclock.idl
...
public abstract class _SystemClockImplBase extends org.omg.CORBA.portable.ObjectImpl
        implements SystemClock, org.omg.CORBA.portable.InvokeHandler {
    ...
    private static String[] __ids = { "IDL:clock/SystemClock:1.0" };
