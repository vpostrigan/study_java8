 ...
 */
public class InternationalizedMortgageCalculator extends JPanel implements PropertyChangeListener {
    ...
    private static void createAndShowGUI(Locale currentLocale) {
        ...
        InternationalizedMortgageCalculator demo = new InternationalizedMortgageCalculator(currentLocale);
