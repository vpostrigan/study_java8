 ...
 */
public class e_DebuggingStreamsWithPeek {

    public static void main(String[] args) {
        // Для проверки простой тест:
        // sumDoublesDivisibleBy3
        new e_DebuggingStreamsWithPeek().sumDoublesDivisibleBy31(100, 120); // 1554

        new e_DebuggingStreamsWithPeek().sumDoublesDivisibleBy32(100, 120); // 1554

        new e_DebuggingStreamsWithPeek().sumDoublesDivisibleBy33(100, 120); // 1554
    }
